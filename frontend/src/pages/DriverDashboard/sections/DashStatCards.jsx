...
function StatCard({ iconBg, icon, trend, value, label, loading }) {
  const display = (loading && value === null) ? <Loader /> : (value ?? '0');
  return (
...
export default function DashStatCards({ totalPoints, transactionsThisMonth, transactionsLoading, ordersCount, ordersLoading, alertsCount, alertsLoading }) {
  return (
    <div className={styles.grid}>
      ...
      <StatCard
        ...
        trend={null}
        value={transactionsThisMonth !== null ? String(transactionsThisMonth) : null}
      ...
      <StatCard
        ...
        trend={null}
        value={ordersCount !== null ? String(ordersCount) : null}
